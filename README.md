...
flowchart TD
   ...
   hypo --> nlp(Natural Language Processing)
...
If there is a solid arrow connecting two of the blocks above then you will need to work through the exercises in the block at the start of the arrow __before__ starting the exercises at the end of the arrow. If there is a dotted line connecting blocks then you will need ideas that are covered in the activity at the start of the arrow to complete the later exercises in the activity at the end of the arrow. You can tackle blocks that are paired in this way in pairs with one partner completing each of the two paired activities. You can then work together when you get to the parts in the activity at the end of the arrow that requires theory that was covered in the activity that is covered in the activity at the start of the arrow.     
